...
if selected_company:
    ...
    if balance_company_df.empty:
        ...
        vertical_parent = {
            ...
            "CUENTAS POR COBRAR RELACIONADAS": "ACTIVO",
            "PROVISIÓN INCOBRABLE Y DETERIORO": "ACTIVO",
            "INVENTARIO": "ACTIVO",
            "CRÉDITO TRIBUTARIO": "ACTIVO",
            "OTROS ACTIVOS CORRIENTES": "ACTIVO",
            "ACTIVO NO CORRIENTE": "ACTIVO",
            "PROPIEDAD, PLANTA Y EQUIPO": "ACTIVO",
            "PROPIEDADES DE INVERSIÓN": "ACTIVO",
            "ACTIVOS BIOLÓGICOS": "ACTIVO",
            "ACTIVO INTANGIBLE": "ACTIVO",
            "ACTIVOS POR IMPUESTOS DIFERIDOS": "ACTIVO",
            "ACTIVOS FINANCIEROS NO CORRIENTES": "ACTIVO",
            "DERECHO DE USO POR ACTIVOS ARRENDADOS": "ACTIVO",
            "DOCUMENTOS Y CUENTAS POR COBRAR NO RELACIONADOS": "ACTIVO",
            "DOCUMENTOS Y CUENTAS POR COBRAR RELACIONADOS": "ACTIVO",
            "OTROS ACTIVOS NO CORRIENTES": "ACTIVO",
            "PASIVO": "PASIVO",
            "PASIVO CORRIENTE": "PASIVO",
            "CUENTAS POR PAGAR": "PASIVO",
            "OBLIGACIONES FINACIERAS CORTO PLAZO": "PASIVO",
        ...
        balance_items = {item["column"]: item for item in balance_structure}
        balance_rows_by_col = {row["_column"]: row for row in balance_rows}
        children_map = {
        ...
        def append_node(node: str, depth: int) -> None:
            row = balance_rows_by_col.get(node)
            item = balance_items.get(node)
        ...
        view_df = visible_df.drop(columns=["_column", "_level", "_is_total"])
