...
st.markdown("### Inicio")
st.write("Usa el menu lateral para abrir `Analisis de Perdidas y Ganancias` o `Analisis de Balance General`.")

if selected_company:
    company_ruc = get_company_ruc(results_data, selected_company)
    render_company_identity(selected_company, company_ruc)
else:
    st.info("Selecciona una empresa en la barra lateral para empezar.")
