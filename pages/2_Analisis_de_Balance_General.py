...
st.set_page_config(page_title="Analisis de Balance General", layout="wide")
render_login_gate()
render_header()
...
render_balance_statement(balance_data, selected_company, company_ruc)
